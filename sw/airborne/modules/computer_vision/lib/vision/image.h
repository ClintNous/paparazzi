...
void image_yuv422_colorfilt_CN(struct image_t *input, struct image_t *output, uint8_t y_m, uint8_t y_M, uint8_t u_m, uint8_t u_M, uint8_t v_m, uint8_t v_M, int32_t* cnt_obst_p);
